...
public class IndexController {
    ...
    @GetMapping("/carousel")
    public PersonalJsonResult carousel() {
    ...
    @GetMapping("/cats")
    public PersonalJsonResult cats() {
    ...
    public PersonalJsonResult subCat(
            @ApiParam(name = "rootCatId", value = "一级分类id", required = true)
            @PathVariable Integer rootCatId) {

        if (rootCatId == null) {
            return PersonalJsonResult.errorMsg("分类不存在");
        }
    ...
    public PersonalJsonResult sixNewItems(
            @ApiParam(name = "rootCatId", value = "一级分类id", required = true)
            @PathVariable Integer rootCatId) {
