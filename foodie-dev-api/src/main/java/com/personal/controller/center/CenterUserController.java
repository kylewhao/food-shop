...
public class CenterUserController extends BaseController {
    ...
    public PersonalJsonResult uploadFace(
...
//        String fileSpace = IMAGE_USER_FACE_LOCATION;
        ...
        if (file != null) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(fileName)) {
                    ...
                    if (!suffix.equalsIgnoreCase("png") &&
                        ...
                        return PersonalJsonResult.errorMsg("图片格式不正确！");
                    }
            ...
            return PersonalJsonResult.errorMsg("文件不能为空！");
        }
    ...
    @PostMapping("update")
    public PersonalJsonResult update(
            @ApiParam(name = "userId", value = "用户id", required = true)
            @RequestParam String userId,
        ...
        if (result.hasErrors()) {
            ...
            return PersonalJsonResult.errorMap(errorMap);
        }
